...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const TIEMPO_CORO = 38; // Inicia justo cuando empieza a cantar: "Él la estaba esperando con flores amarillas..."
  ...
  // Intentar iniciar audio de inmediato
  activarMusicaCantada();

  // Si termina la canción, reiniciar desde el coro famoso cantado
  musicaFondo.addEventListener("ended", () => {
    musicaFondo.currentTime = TIEMPO_CORO;
    musicaFondo.play();
  });

  // Botón MUTE / UNMUTE (Silenciar o Activar)
  ...
  // Evento universal para Celulares y PC: Al primer toque en la pantalla inicia la canción cantada
